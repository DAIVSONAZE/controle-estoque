...
<body>
	...
	<div>
			...
			<p>
				Descrição: <br /> <input type="text" id="descricao" name="descricao" value="${produto.descricao}">
			</p>
			<p>
				Categoria: <br /> <select id="categoriaProduto" name="categoriaProduto">
		...
		<tr style='background-color: #E6E6E6; font-weight: bold;'>
			...
			<c:forEach var="produto" items="${listaProduto}">
				<tr>
					...
					<td><img alt="Maquina de Solda"
						src="/view/img/${produto.imagem}" style="width: 30%;"></td>
