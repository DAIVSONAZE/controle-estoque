...
<body>
	...
	<hr>
	<form action="alterandoProduto" method="post"
		...
		<p>
			<br /> <input type="hidden" name="id" value="${produto.id}"
				maxlength="5" />
		</p>

		<p>
			Código: <br /> <input type="text" name="codigo"
				value="${produto.codigo}" maxlength="5" />
		</p>
		...
		<p>
			Categoria: <br /> <select name="categoriaProduto">
