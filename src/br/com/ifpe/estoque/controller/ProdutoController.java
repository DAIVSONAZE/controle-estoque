...
public class ProdutoController {
	...
	public String incluirProduto(@Valid Produto produto, BindingResult result,
			@RequestParam("file") MultipartFile imagem, Model model) {
	...
	public String listarProduto(Model model) {
		...
		List<Produto> listaProduto = dao1.listar();
