...
// ================================================================================//
	...
	public void salvar(Produto produto) {
		try {
			String sql = "INSERT INTO produto (codigo, descricao, precocusto, precovenda, garantia, quantidade, imagem, categoria_id) VALUES (?,?,?,?,?,?,?,?)";
	...
	public List<Produto> listar() {
		...
		try {
			...
			while (rs.next()) {
				...
				CategoriaProduto categoria = dao.buscarPorId(id);
	...
	public List<Produto> pesquisar(String descricao, Integer idCategoria) {
		...
		try {
			...
			if (!descricao.equals("") && idCategoria == null) {
				...
				stmt = this.connection.prepareStatement("SELECT * FROM produto WHERE descricao LIKE ? AND categoria_id = ? ORDER BY descricao");
				stmt.setString(1, "%" + descricao + "%");
